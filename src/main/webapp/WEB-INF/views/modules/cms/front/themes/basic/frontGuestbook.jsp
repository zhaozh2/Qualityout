		...
		<div>
			<div style="width: 100%">
				<h4 style="margin: 10px;">
					<span
						style="float: right; color: #999; font-size: 12px; font-weight: normal;">当前位置：<a
						href="/f">网站首页</a> &gt;&gt; 站长信箱
					</span>站长信箱
				</h4>
			</div>
			<div style="margin: 15px 0;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;站长信箱是我局反映信访问题的渠道之一，也是我局进一步密切与人民群众联系的桥梁和纽带。受理举报、咨询、批评建议、申诉、控告及其他要求解决个人问题的信访事项。
				请填写下面表单，您的问题我们将及时反馈给您，非常感谢你的支持。<br><font style="color:red"> 注：如您需要得到有关方面的答复，请您详细如实填写联系电话或联系地址！</font></div>
		</div>
		<h4>我要留言</h4>
